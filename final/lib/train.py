...
class Train(object):
    ...
    def _feature(self):
        ...
        data = data[(data['year'] != 2017) & (data['month'] != 5)]
    ...
    def _train(self):
        ...
        param_grid = {
            ...
            'alpha': [0, 0.1, 0.2],  # 更大的 alpha alpha: L1 正则化项。增加这个值会使模型更简单。
            'lambda': [1, 2, 3],  # 更大的 lambda L2 正则化项。增加这个值会使模型更简单。
        ...
        model.fit(X_train, y_train, eval_metric="auc", eval_set=evals, early_stopping_rounds=30,
    ...
    def _pred(self):
        ...
        print(self.pred_data.dtypes)
        print(self.pred_data['area'])
        # # 创建DMatrix对象
